<?php
	...
	if (!isset($_SESSION['lang']))
	{
		...
		if ($browserLang !== 'vi')
		{
			$url = "en/how-it-works.php?lang=en";
			header("Location: $url");
			ob_end_flush();
		}
	}
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>LintinZone - Cách thức hoạt động</title>
	...
	<body>
		...
		<div class="content">
			...
			<h3>Cần chuyển hàng</h3>
			<ol>
				<li>
					Bạn đăng món hàng cần vận chuyển lên LintinZone.<br />
					<img src="public/images/lintinzone-order-vn-1.png" width="453" height="67" title="Quá trình cần chuyển hàng - bước thứ nhất" alt="Bước thứ nhất, đăng món hàng" />
				</li>
				<li>
					LintinZone giới thiệu những người có thể chuyển hàng.<br />
					<img src="public/images/lintinzone-order-vn-2.png" width="453" height="91" title="Quá trình cần chuyển hàng - bước thứ hai" alt="Bước thứ hai, LintinZone giới thiệu người chuyển hàng (shipper)" />
				</li>
				<li>
					Bạn liên hệ người chuyển hàng để được chuyển.
				</li>
				<li>
					Bạn nhận được hàng và trả phí cho người chuyển. Giao dịch hoàn tất.
				</li>
			</ol>
			<h3>Chuyển hàng cho người khác</h3>
			<ol>
				<li>
					Bạn đăng chuyến đi của mình lên LintinZone.<br />
					<img src="public/images/lintinzone-ship-vn-1.png" width="453" height="65" title="Quá trình chuyển hàng - bước thứ nhất" alt="Bước thứ nhất, đăng chuyến đi." />
				</li>
				<li>
					LintinZone giới thiệu những người có hàng cần chuyển.<br />
					<img src="public/images/lintinzone-ship-vn-2.png" width="453" height="91" title="Quá trình chuyển hàng - bước thứ hai" alt="Bước thứ hai, LintinZone giới thiệu những người có hàng muốn chuyển." >
				</li>
				<li>
					Bạn liên hệ với người có nhu cầu chuyển hàng.
				</li>
				<li>
					Bạn chuyển hàng và nhận được phí từ người cần chuyển. Giao dịch hoàn tất.
				</li>
			</ol>
			<div class="social-plugins">
				<!-- AddThis Button BEGIN -->
