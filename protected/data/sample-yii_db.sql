...
--
-- Table structure for table `syii_email_verification`
--

CREATE TABLE IF NOT EXISTS `syii_email_verification` (
...
--
-- Table structure for table `syii_locations`
--

CREATE TABLE IF NOT EXISTS `syii_locations` (
...
--
-- Table structure for table `syii_location_types`
--

CREATE TABLE IF NOT EXISTS `syii_location_types` (
...
--
-- Table structure for table `syii_login_history`
--

CREATE TABLE IF NOT EXISTS `syii_login_history` (
...
--
-- Table structure for table `syii_profile_fields`
--

CREATE TABLE IF NOT EXISTS `syii_profile_fields` (
...
--
-- Table structure for table `syii_profile_info`
--

CREATE TABLE IF NOT EXISTS `syii_profile_info` (
...
--
-- Table structure for table `syii_trips`
--

CREATE TABLE IF NOT EXISTS `syii_trips` (
...
--
-- Table structure for table `syii_trip_statuses`
--

CREATE TABLE IF NOT EXISTS `syii_trip_statuses` (
...
--
-- Table structure for table `syii_users`
--

CREATE TABLE IF NOT EXISTS `syii_users` (
